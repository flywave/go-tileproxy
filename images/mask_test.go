...
func TestMaskOutsideOfImageTransparent(t *testing.T) {
	...
	result := MaskImageSourceFromCoverage(
		img, vec2d.Rect{Min: vec2d.T{0, 0}, Max: vec2d.T{10, 10}}, geo.NewSRSProj4("EPSG:4326"), geo.NewBBoxCoverage(vec2d.Rect{Min: vec2d.T{20, 20}, Max: vec2d.T{30, 30}}, geo.NewSRSProj4("EPSG:4326"), false), &img_opts)
